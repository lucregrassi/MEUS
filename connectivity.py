...
# #             #     # node[1]['connection'] = list(node[1]['connection'])
# #             #     # node[1]['connection'].clear()
# #             #     # node[1]['connection'] = node[1]['connection'][1:]
# #             #     node[1]['connection'] = str(connection)
# #             #     # print(node[1]['connection'])
# #             #     # print(type(node[1]['connection']))
# #             #     # input()
# #             # else:
# #             #     node[1]['connection'] += str()
# #             # # Add the connection passed as parameter to the connections of that node
# #             # # node[1]['connection'] = str(connection)#str(node[1]['connection']) + str(connection)
# #             # # node[1]['connection'].append(str(connection))
    
# #             # # print(len(node[1]['connection'][1:]))
# #             # # print("#####################")
